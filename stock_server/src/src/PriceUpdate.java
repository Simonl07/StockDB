...
public class PriceUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Stock s: stocks) {
			if (s.getLatest_price() != null) {
				writer.write("<p> <Strong>(" + s.getSYMBOL() + ") " + s.getNAME_FULL() + ":</Strong> <br />" + "&nbsp;&nbsp;&nbsp;&nbsp; Price: " + s.getLatest_price()
						+ "&nbsp;&nbsp;&nbsp;&nbsp; Volume: " + s.getLatest_volume().toString() + "&nbsp;&nbsp;&nbsp;&nbsp; Last updated "
						+ Duration.between(s.getLast_update(), LocalDateTime.now()).getSeconds() + " seconds ago by " + s.getLastCrawl() + "</p>");
			}
		}
		writer.write("</html></body>");
	}
